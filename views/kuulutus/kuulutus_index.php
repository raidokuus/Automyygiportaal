	...
	<div class="row">
        <div class="span8">
            <div class="control-group">
                ...
                <div class="controls"><input name="liik" type="radio" value="" id="liik"> Sõiduauto
                </div>
                <div class="controls"><input name="liik" type="radio" value="" id="liik"> Maastur
                </div>
                <div class="controls"><input name="liik" type="radio" value="" id="liik"> Kaubik
                </div>
                <div class="controls"><input name="liik" type="radio" value="" id="liik"> Mototehnika
                </div>
